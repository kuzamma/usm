...
path("staff/view/view_staff_competency_journal/", hod_views.view_staff_competency_journal, name="view_staff_competency_journal"),

    path("staff/manage/", hod_views.manage_staff, name='manage_staff'),

    path("formal/manage/", hod_views.manage_formal, name='manage_formal'),
